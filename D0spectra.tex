...
\begin{tabular}{rcccccccc} \hline \hline
  ...
  0--10 \%\hspace{1cm}     & 0.260 & $\pm$ & 0.014 & & 0.065 & $\pm$ & 0.006 \\
  10--20 \%\hspace{1cm}    & 0.255 & $\pm$ & 0.016 & & 0.070 & $\pm$ & 0.007 \\
  20--40 \%\hspace{1cm}    & 0.259 & $\pm$ & 0.015 & & 0.071 & $\pm$ & 0.006 \\
  40--60 \%\hspace{1cm}    & 0.242 & $\pm$ & 0.024 & & 0.074 & $\pm$ & 0.011 \\
  60--80 \%\hspace{1cm}    & 0.186 & $\pm$ & 0.048 & & 0.080 & $\pm$ & 0.010  \\ \hline \hline
\end{tabular}
}
\label{table:TBW_fit}
\end{table}
