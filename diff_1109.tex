...
%DIF DEL Bak/D0spectra.1024.tex                                                                                            Fri Nov  9 23:12:48 2018
%DIF ADD ./Centrality-and-transverse-momentum-dependence-of-D-0--meson-production-at-mid-rapidity-in-Au-Au/D0spectra.tex   Fri Nov  9 23:03:29 2018
%
...
%DIF < \author{Ann Author}
%DIF >  \author{Ann Author}
% \altaffiliation[Also at ]{Physics Department, XYZ University.}%Lines break automatically or can be forced with \\
%DIF < \author{Second Author}%
%DIF >  \author{Second Author}%
% \email{Second.Author@institution.edu}
%DIF < \affiliation{% Authors' institution and/or address\\ This line break forced with \textbackslash\textbackslash
%DIF < }%
%DIF >  \affiliation{% Authors' institution and/or address\\ This line break forced with \textbackslash\textbackslash
%DIF >  }%
...
J.~Butterworth$^{41}$,
H.~Caines$^{59}$,
M.~Calder}{\DIFadd{\'o}}\DIFadd{n~de~la~Barca~S}{\DIFadd{\'a}}\DIFadd{nchez$^{7}$,
D.~Cebra$^{7}$,
I.~Chakaberia$^{24,45}$,
P.~Chaloupka$^{13}$,
B.~K.~Chan$^{8}$,
...
\DIFaddend \collaboration{STAR Collaboration}
\noaffiliation
...
\DIFaddbegin \DIFadd{Figure~\ref{fig:Datad0Eff} shows the total $D^{0}$ reconstruction efficiency from different centrality classes in Au + Au collisions at $\sqrt{s_{_{\rm NN}}}$ = 200\,GeV includes each individual complement discussed above.
}
