...
%DIF ADD D0spectra.1209.tex   Mon Dec 10 16:20:41 2018
%
...
\DIFadd{Precision tracking for this analysis is achieved with }\DIFaddend the TPC and \DIFdelbegin \DIFdel{TOF detectors provide }\DIFdelend \DIFaddbegin \DIFadd{HFT detectors and }\DIFaddend particle identification for stable hadrons \DIFdelbegin \DIFdel{. The TPC and TOF detectors cover the full azimuth and pseudorapidity range $|\eta|<1$~\mbox{%DIFAUXCMD
